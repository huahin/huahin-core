 ...
 */
public class MasterTextRecordReader extends RecordReader<Key, Value> {
    private static final Log LOG = LogFactory.getLog(MasterTextRecordReader.class);
    ...
    public void initialize(InputSplit genericSplit, TaskAttemptContext context)
        ...
        // make valu creator
        String[] labels = conf.getStrings(SimpleJob.MASTER_LABELS);
        if (labels == null) {
